...
const RoomComponent = ({ hotelDetails, hotel_id, checkin, checkout }) => {
    ...
    const addToCart = (room) => {
        ...
        let taxes = 0;
        // if (hotelDetails.destination_id != 702 && hotelDetails.destination_id != 1) {
        //     taxes = Math.round(discountedPrice * 0.265);
        // }
