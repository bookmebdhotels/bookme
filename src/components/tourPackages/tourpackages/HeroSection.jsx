    ...
    <section className="relative">
      <div className="relative h-[30vh] md:h-[60vh] w-full overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-center text-white px-4">
          <h1 className="hidden lg:block text-2xl md:text-3xl font-bold mb-2 sm:mb-4 drop-shadow-lg">
            Discover Your Perfect Tour Package
          </h1>
          <p className="hidden lg:block  text-sm md:text-md max-w-2xl mx-auto drop-shadow-md">
