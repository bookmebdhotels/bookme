...
export const metadata = {
  title: "EMI Terms & Conditions - BookMe",
  description: "Read the terms and conditions for using the Equated Monthly Installment (EMI) service on BookMe.",
  alternates: {
    canonical: "https://bookme.com.bd/emi-policy",
  },
};
