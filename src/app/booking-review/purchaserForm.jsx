...
export default function PurchaserForm({
  guestInfo,
  user,
  onGuestInfoChange,
  bookingData,
...
const handleInputChange = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!guestInfo.name) newErrors.name = "Guest name is required.";
    if (!guestInfo.purchaser_name) newErrors.purchaser_name = "Purchaser name is required.";
    if (!bdPhoneRegex.test(guestInfo.phone)) newErrors.phone = "Please enter a valid Bangladeshi phone number.";
    ...
    const confirmedBooking = {
      ...
      purchaser_name: guestInfo.purchaser_name,
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <FormField
          ...
          helperText={errors.phone && <span className="text-red-600">{errors.phone}</span>}
        />

        <FormField
          label="Guest Email Address (Optional)"
          id="email"
          name="email"
          type="email"
        ...
        <FormField
          ...
          name="purchaser_name"
          type="text"
          value={guestInfo.purchaser_name || ""}
          onChange={handleInputChange}
          required
          placeholder="Enter your full name"
          helperText={
            errors.purchaser_name
              ? <span className="text-red-600">{errors.purchaser_name}</span>
              : user
